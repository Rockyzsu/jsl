...
class RelationshipSpider(Spider):
    ...
    follow_url = 'https://www.jisilu.cn/people/ajax/follows/type-follows__uid-{user_id}__page-{page}'
    fan_url = 'https://www.jisilu.cn/people/ajax/follows/type-fans__uid-{user_id}__page-{page}'
